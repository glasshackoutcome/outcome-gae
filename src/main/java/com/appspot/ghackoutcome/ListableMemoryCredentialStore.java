...
public class ListableMemoryCredentialStore implements CredentialStore {
  ...
  class MemoryPersistedCredential {
     ...
     *
     * @param credential credential whose {@link com.google.api.client.auth.oauth2.Credential#getAccessToken access token},
     *                   {@link com.google.api.client.auth.oauth2.Credential#getRefreshToken refresh token}, and
     *                   {@link com.google.api.client.auth.oauth2.Credential#getExpirationTimeMilliseconds expiration time} need to be stored
     */
     ...
     *
     * @param credential credential whose {@link com.google.api.client.auth.oauth2.Credential#setAccessToken access token},
     *                   {@link com.google.api.client.auth.oauth2.Credential#setRefreshToken refresh token}, and
     *                   {@link com.google.api.client.auth.oauth2.Credential#setExpirationTimeMilliseconds expiration time} need to be set if the
